...
const resources = {
  ...
  ar: {
    translation: {
      ...
      "contact":"اتصال",
      "abouttext":"أنا متخصص في تصميم برامج الإدارة. لقد طورت نشاطي منذ عام 2015 حول خدمات تكنولوجيا المعلومات المختلفة المخصصة للشركات. أنا تحت تصرفك لتقديم المشورة لك وإرشادك قدر الإمكان نحو حلول برمجية تتكيف مع مهنتك واحتياجاتك. يمكننا أن نجتمع لمناقشة مشاريعك.",
      ...
      "abouttxt4":"تصميم واجهات أنيقة وبديهية على برنامج أو أداة ويب للحصول على سهولة كبيرة في الاستخدام (UI / UX).", 

      "aboutname":" أمين عباوي",
      "aboutprofil":"مطور ومصمم جرافيك",
      ...
      "certificatt2":"معتمد PHP مطور",
      "certificatt3":"تصميم التطبيق المحمول في PHOTOSHOP من الصفر",
